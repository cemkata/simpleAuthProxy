...
class WebServerPlugin(HttpWebServerBasePlugin):
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.destinationIP = "10.21.32.55"
        self.destinationPort = "8080"
        self.destinationProtocol = "http"
        self.destinationIPAuth = "127.0.0.1"
        self.destinationPortAuth = "8000"
        self.destinationProtocolAuth = "http"
